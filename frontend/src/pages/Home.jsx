...
export default function Home() {
  return (
    <div data-testid="home-page">
      ...
      {/* DESIGNER CTA — MOVED UP per revision: right after marquee, before products */}
      <section className="py-24 md:py-32 bg-[#0c0c0c] border-b border-white/10 relative overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
              ...
              <p className="text-white/70 text-lg leading-relaxed mb-8 max-w-lg">
                Tools interaktif untuk meletakkan logo, nama, dan teks pada mockup jaket. Setelah selesai, kirim langsung ke WhatsApp kami atau download mockup-nya.
              </p>
